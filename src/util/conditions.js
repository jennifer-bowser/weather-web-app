...
const conditions = {
    ...
    4: new Condition("intermittent clouds", few_clouds_day, null, colors.mid_sun_yellow, "and"),
    ...
    23: new Condition("mostly cloudy and snowing", partial_snow_day, partial_snow_night, colors.partial_snow_white, "and"),
    ...
    41: new Condition("partly cloudy with thunderstorms", null, thunderstorm_night, null, "with"),
    42: new Condition("mostly cloudy with thunderstorms", null, thunderstorm_night, null, "with"),
